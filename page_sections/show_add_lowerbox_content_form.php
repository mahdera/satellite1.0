    ...
    <div class="tab-pane fade in active">
        ...
        <form role="form">            
            <div class="form-group">        
                ...
                <input ng-model="centerBoxForm.whichColumn" class="form-control" id="whichColumn" name="whichColumn" type="text" placeholder="Enter the title..." required=""/>
                <select name="slctcolumn" id="slctcolumn" style="width:50%">
